...
const field_t fields[] = {
	...
	{ "cvar", FOFS(cvar), F_LSTRING },
	{ "cvarValue", FOFS(cvarValue), F_LSTRING },
...
void G_SpawnGEntityFromSpawnVars(void) {
	...
	static char *gametypeNames[] = { "ffa", "duel", "race", "tdm", "ca", "ctf", "1f", "ob", "har", "ft", "dom", "ad", "rr" };
	...
	// check for "notteam" flag (GT_FFA, GT_DUEL, GT_RACE)
