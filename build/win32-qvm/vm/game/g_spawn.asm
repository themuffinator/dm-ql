...
pop
line 559
;559:	trap_SetConfigstring(CS_MAP_AUTHOR1, s);
CNSTI4 12
ARGI4
ADDRLP4 0
INDIRP4
...
pop
line 562
;562:	trap_SetConfigstring(CS_MAP_AUTHOR2, s);
CNSTI4 13
ARGI4
ADDRLP4 0
INDIRP4
...
;584:	if ( /*g_restarted.integer ||*/ g_gametype.integer == GT_SINGLE_PLAYER ) {
ADDRGP4 g_gametype+12
INDIRI4
CNSTI4 2
NEI4 $316
