...
line 274
;273:	default:
;274:		BG_sprintf(buf, "Gametype #%i", cgs.gametype);
ADDRLP4 8
ARGP4
ADDRGP4 $186
ARGP4
...
line 278
;277:	}
;278:	UI_DrawProportionalString(320, y, s,
CNSTI4 320
ARGI4
ADDRLP4 4
INDIRI4
...
pop
line 280
;279:		UI_CENTER | UI_SMALLFONT | UI_DROPSHADOW, colorWhite);
;280:	y += PROP_HEIGHT;
ADDRLP4 4
ADDRLP4 4
INDIRI4
...
line 282
;281:
;282:	value = atoi(Info_ValueForKey(info, "timelimit"));
ADDRLP4 1032
INDIRP4
ARGP4
ADDRGP4 $189
...
EQI4 $190
line 284
;284:		UI_DrawProportionalString(320, y, va("timelimit %i", value),
ADDRGP4 $192
ARGP4
ADDRLP4 1036
INDIRI4
...
line 289
;288:
;289:	if (cgs.gametype < GT_CTF) {
ADDRGP4 cgs+31480
INDIRI4
CNSTI4 5
GEI4 $193
line 290
;290:		value = atoi(Info_ValueForKey(info, "fraglimit"));
ADDRLP4 1032
INDIRP4
ARGP4
ADDRGP4 $196
...
EQI4 $197
line 292
;292:			UI_DrawProportionalString(320, y, va("fraglimit %i", value),
ADDRGP4 $199
ARGP4
ADDRLP4 1036
INDIRI4
...
line 298
;297:
;298:	if (cgs.gametype >= GT_CTF) {
ADDRGP4 cgs+31480
INDIRI4
CNSTI4 5
LTI4 $200
line 299
;299:		value = atoi(Info_ValueForKey(info, "capturelimit"));
ADDRLP4 1032
INDIRP4
ARGP4
ADDRGP4 $203
...
EQI4 $204
line 301
;301:			UI_DrawProportionalString(320, y, va("capturelimit %i", value),
ADDRGP4 $206
ARGP4
ADDRLP4 1036
INDIRI4
...
pop
line 303
;302:				UI_CENTER | UI_SMALLFONT | UI_DROPSHADOW, colorWhite);
;303:			y += PROP_HEIGHT;
ADDRLP4 4
ADDRLP4 4
INDIRI4
