...
line 1068
;1067:
;1068:			if (pm_model && myClientNum != clientNum && cgs.gametype != GT_SINGLE_PLAYER) {
ADDRLP4 8
INDIRI4
CNSTI4 0
EQI4 $586
...
line 1089
;1088:
;1089:			} else if (cg_enemyModel.string[0] && myClientNum != clientNum && !allowNativeModel && cgs.gametype != GT_SINGLE_PLAYER) {
ADDRGP4 $532
JUMPV
LABELV $586
ADDRGP4 cg_enemyModel+16
