...
line 384
;383:
;384:void UI_DrawHandlePic( float x, float y, float w, float h, qhandle_t hShader ) {
line 390
;385:	float	s0;
;386:	float	s1;
;387:	float	t0;
...
;416:UI_FillRect
;417:
;418:Coordinates are 640*480 virtual values
;419:=================
;420:*/
;421:void UI_FillRect( float x, float y, float width, float height, const float *color ) {
line 422
;422:	trap_R_SetColor( color );
ADDRFP4 16
INDIRP4
ARGP4
...
line 424
;423:
;424:	UI_AdjustFrom640( &x, &y, &width, &height );
ADDRFP4 0
ARGP4
ADDRFP4 4
ARGP4
...
pop
line 425
;425:	trap_R_DrawStretchPic( x, y, width, height, 0, 0, 0, 0, uiInfo.uiDC.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
line 430
;429:
;430:void UI_DrawSides(float x, float y, float w, float h) {
line 431
;431:	UI_AdjustFrom640( &x, &y, &w, &h );
ADDRFP4 0
ARGP4
ADDRFP4 4
ARGP4
...
pop
line 432
;432:	trap_R_DrawStretchPic( x, y, 1, h, 0, 0, 0, 0, uiInfo.uiDC.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
pop
line 433
;433:	trap_R_DrawStretchPic( x + w - 1, y, 1, h, 0, 0, 0, 0, uiInfo.uiDC.whiteShader );
ADDRFP4 0
INDIRF4
ADDRFP4 8
INDIRF4
...
line 436
;435:
;436:void UI_DrawTopBottom(float x, float y, float w, float h) {
line 437
;437:	UI_AdjustFrom640( &x, &y, &w, &h );
ADDRFP4 0
ARGP4
ADDRFP4 4
ARGP4
...
pop
line 438
;438:	trap_R_DrawStretchPic( x, y, w, 1, 0, 0, 0, 0, uiInfo.uiDC.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
pop
line 439
;439:	trap_R_DrawStretchPic( x, y + h - 1, w, 1, 0, 0, 0, 0, uiInfo.uiDC.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
;443:UI_DrawRect
;444:
;445:Coordinates are 640*480 virtual values
;446:=================
;447:*/
;448:void UI_DrawRect( float x, float y, float width, float height, const float *color ) {
line 449
...
line 451
;450:
;451:  UI_DrawTopBottom(x, y, width, height);
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
pop
line 452
;452:  UI_DrawSides(x, y, width, height);
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
line 457
;456:
;457:void UI_SetColor( const float *rgba ) {
line 458
;458:	trap_R_SetColor( rgba );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 trap_R_SetColor
...
line 461
;460:
;461:void UI_UpdateScreen( void ) {
line 462
;462:	trap_UpdateScreen();
...
;464:
;465:
;466:void UI_DrawTextBox (int x, int y, int width, int lines)
;467:{
line 468
;468:	UI_FillRect( x + BIGCHAR_WIDTH/2, y + BIGCHAR_HEIGHT/2, ( width + 1 ) * BIGCHAR_WIDTH, ( lines + 1 ) * BIGCHAR_HEIGHT, colorBlack );
ADDRFP4 0
INDIRI4
CNSTI4 8
ADDI4
...
pop
line 469
;469:	UI_DrawRect( x + BIGCHAR_WIDTH/2, y + BIGCHAR_HEIGHT/2, ( width + 1 ) * BIGCHAR_WIDTH, ( lines + 1 ) * BIGCHAR_HEIGHT, colorWhite );
ADDRFP4 0
INDIRI4
CNSTI4 8
ADDI4
...
line 473
;471:
;472:qboolean UI_CursorInRect (int x, int y, int width, int height)
;473:{
line 474
;474:	if (uiInfo.uiDC.cursorx < x ||
ADDRLP4 0
ADDRFP4 0
INDIRI4
ASGNI4
...
LABELV $307
line 478
;475:		uiInfo.uiDC.cursory < y ||
;476:		uiInfo.uiDC.cursorx > x+width ||
;477:		uiInfo.uiDC.cursory > y+height)
;478:		return qfalse;
CNSTI4 0
RETI4
ADDRGP4 $298
